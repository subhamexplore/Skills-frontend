    ...
    return(
            <div id="section2">
                <div className="section2items sm:text-lg" style={{color:'#858298',fontFamily:'Inter'}}>
                    ...
                    <br/>
                    <br/>
                    <span className=" text-justify flex items-center justify-between"><img src={discordlogo} alt="discordlogo" className="h-9" /><div className="ml-3 leading-tight">Get <span className="text-white font-bold">registered </span>and join your respective domain <span className="text-white font-bold">discord </span>channel mentioned after registration</div></span>
                    <br/>
                    <span className="flex items-center"><img src={chatlogo} alt="chatlogo" className="h-9" />
