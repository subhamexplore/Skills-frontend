...
const Profile = (
  {username = 'Abhinaba Dash',email='abhinabadash19@gmail.com',badge1=nobadgelogo,badge2=nobadgelogo,domain1name='Web Dev',domain2name='App Dev'}) => {
    return(
        <div id="profile" className="flex max-w-[1084px] min-h-[591px]">
            <div className="flex items-end">
                <img src={img} alt="profileimg" className="w-[464px] h-[486px] mb-4" id="profilelogo" />
            </div>
            <div>
                <div id="profileheading" className="mb-4" style={{padding:'0px 16px 10px 16px'}}>
                ...
                <div className="mb-4">
                    <div className="mb-4"  id="profiletext">
                        <div id="userdetails">
                        <div className="flex items-center gap-1 "><img src={usernamelogo} alt="usernamelogo" className="h-4 w-4"/>{username}</div>
                        <div className="flex items-center gap-1"><img src={emaillogo} alt="emaillogo" className="h-4 w-4"/>{email}</div>
                        </div>
                    ...
                    <div className="flex max-w-[538px] flex-wrap justify-center items-center gap-[20px]">    
                        <div id="domaincards" className="min-h-[355px] rounded-2xl" style={{
                                background:'#1A1635'
                            }}>
                            <div className="flex justify-around h-[240px]">
                                <img
                                src={badge1} style={{width: '111.77px',minHeight:'208px',padding:'16px 0px 16px 0px'}}
                                />
                            </div>
                            <div className="p-3 flex flex-col gap-[24px] rounded-b-2xl" style={{background:'#362D6D'}}>
                            ...
                            <div className="flex justify-around h-[240px]">
                                <img
                                src={nobadgelogo} style={{width: '111.77px',minHeight:'208px',padding:'16px 0px 16px 0px'}}
                                />
                            </div>
                            <div className="p-3 flex flex-col gap-[24px] rounded-b-2xl" style={{background:'#362D6D'}}>
